...
wxWindow* PreferencesDialog::create_general_page()
{
    ...
    */
    ...
    auto item_device_tab_post_upload = create_item_checkbox(_L("Switch to Device tab after upload"), page, _L("If enabled, Snapmaker Orca switches to the Device tab after a plate has been uploaded to the printer."), 50, "open_device_tab_post_upload");
    ...
    sizer_page->Add(item_device_tab_post_upload, 0, wxTOP, FromDIP(3));
